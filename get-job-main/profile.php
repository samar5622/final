...
if((isset($_POST['save'])&&($_POST['city']&&$_POST['job_section']&&$_POST['gender']&&$_POST['career_level']&&$_POST['experience']&&$_POST['time']&&$_POST['contact']&&$_POST['details']!=null))){
    ...
    $query = "INSERT INTO profile (first,last,city,job,gender,current_level,exp,type_time,email,details) VALUES ('$first','$last','$city','$job','$gender','$career','$exp','$time','$contact','$details')";
    db_connect($query);
...
<form action="profile.php" method="post" class="row g-3">
 <!--   <div class="col-md-6">
    ...
    <div class="input-group">
        ...
        <textarea class="form-control" aria-label="With textarea" name="first" placeholder="first name" ></textarea>
    </div>
    <div class="input-group">
       
        <textarea class="form-control" aria-label="With textarea" name="last" placeholder="last name"></textarea>
    </div>
    <div class="col-md-68">
